...
namespace VideoGameStore.Controllers
{
    public class Wish_ListController : Controller
    {
        ...
        //    wish.user_id = int.Parse(db.Users.Include(u => u.user_id).Where(f => f.username == this.User.Identity.Name).ToString());
        //    wish.game_id = int.Parse(id.ToString());
        //    wish.date_added = DateTime.Today;
        //    wish.Game = db.Games.Find(id);
        //    wish.User = db.Users.Find(wish.user_id);
        //    return View(wish);
        //}
